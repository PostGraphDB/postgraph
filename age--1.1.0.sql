...
CREATE FUNCTION age_toboolean(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_tofloat(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_toupper(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_tolower(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_ltrim(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_rtrim(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_trim(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
RETURNS NULL ON NULL INPUT
...
CREATE FUNCTION age_right(agtype, agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_left(agtype, agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_cos(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_tan(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_cot(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_asin(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_acos(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_atan(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_atan2(agtype, agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_degrees(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_radians(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_ceil(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
