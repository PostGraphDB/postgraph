...
SELECT * FROM cypher('expr', $$ RETURN '40 Days'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '10 Weeks'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '10 Months'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '3 Years'::interval $$) AS r(result gtype);

SELECT * FROM cypher('expr', $$ RETURN '30 Seconds Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '15 Minutes Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '10 Hours Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '40 Days Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '10 Weeks Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '10 Months Ago'::interval $$) AS r(result gtype);
SELECT * FROM cypher('expr', $$ RETURN '3 Years Ago'::interval $$) AS r(result gtype);
...
SELECT result = CURRENT_DATE::gtype FROM cypher('expr', $$
    RETURN CURRENT_DATE
$$) AS r(result gtype);
...
--
SELECT result = LOCALTIMESTAMP::gtype FROM cypher('expr', $$ RETURN LOCALTIMESTAMP $$) AS r(result gtype);
SELECT result = LOCALTIMESTAMP(1)::gtype FROM cypher('expr', $$ RETURN LOCALTIMESTAMP(1) $$) AS r(result gtype);
SELECT result = LOCALTIME::gtype FROM cypher('expr', $$ RETURN LOCALTIME $$) AS r(result gtype);
SELECT result = LOCALTIME(1)::gtype FROM cypher('expr', $$ RETURN LOCALTIME(1) $$) AS r(result gtype);
