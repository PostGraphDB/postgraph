...
# 2.8.8)
#
# PG_RELEASE_VERSION - the actual release number (like 13.13 or 16.1)
#
# ----------------------------------------------------------------------------
...
if(PostgreSQL_FOUND)
    ...
    string(REGEX MATCH "[0-9]+\\.[0-9]+" _pg_release_version ${PostgreSQL_VERSION_STRING})
    set(PG_RELEASE_VERSION "${_pg_release_version}" CACHE STRING "Postgres release version")
