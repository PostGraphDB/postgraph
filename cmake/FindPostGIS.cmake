...
if(NOT EXISTS "${POSTGIS_DIR_VERSION}/build/bin/postgis")
        ...
        include_directories(${POSTGIS_DIR}/proj/proj-9.3.1/src)
        ...
        file(MAKE_DIRECTORY "${POSTGIS_DIR}/build")
        ...
        execute_process(
                COMMAND bash -c "./configure ${extra_configure_args} --prefix=${POSTGIS_DIR}/build --with-pgconfig=${PG_CONFIG} --with-proj=${POSTGIS_DIR}/proj/build/bin --without-protobuf --without-raster --without-topology"
                WORKING_DIRECTORY "${POSTGIS_DIR_VERSION}/postgis-${POSTGIS_VER}"
        ...
        execute_process(COMMAND make WORKING_DIRECTORY "${PGDIR_VERSION}/postgis-${PGVER_ALIAS}")
