 ...
 *-------------------------------------------------------------------------
 */
#ifndef CYPHER_REWRITE_HEAP_H
#define CYPHER_REWRITE_HEAP_H
...
extern RewriteState cypher_begin_heap_rewrite(Relation OldHeap, Relation NewHeap,
									   TransactionId OldestXmin, TransactionId FreezeXid,
									   MultiXactId MultiXactCutoff);
extern void cypher_end_heap_rewrite(RewriteState state);
extern void cypher_rewrite_heap_tuple(RewriteState state, HeapTuple oldTuple,
							   HeapTuple newTuple);
extern bool cypher_rewrite_heap_dead_tuple(RewriteState state, HeapTuple oldTuple);
...
void		CypherCheckPointLogicalRewriteHeap(void);
