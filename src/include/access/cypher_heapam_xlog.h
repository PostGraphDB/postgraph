 ...
 *-------------------------------------------------------------------------
 */
#ifndef CYPHER_HEAPAM_XLOG_H
#define CYPHER_HEAPAM_XLOG_H
 ...
 */
#define CYPHER_XLOG_HEAP_INSERT		0x00
#define CYPHER_XLOG_HEAP_DELETE		0x10
#define CYPHER_XLOG_HEAP_UPDATE		0x20
#define CYPHER_XLOG_HEAP_TRUNCATE		0x30
#define CYPHER_XLOG_HEAP_HOT_UPDATE	0x40
#define CYPHER_XLOG_HEAP_CONFIRM		0x50
#define CYPHER_XLOG_HEAP_LOCK			0x60
#define CYPHER_XLOG_HEAP_INPLACE		0x70
...
extern void CypherHeapTupleHeaderAdvanceLatestRemovedXid(HeapTupleHeader tuple,
												   TransactionId *latestRemovedXid);

extern void cypher_heap_redo(XLogReaderState *record);
extern void cypher_heap_desc(StringInfo buf, XLogReaderState *record);
extern const char *cypher_heap_identify(uint8 info);
extern void cypher_heap_mask(char *pagedata, BlockNumber blkno);
extern void cypher_heap2_redo(XLogReaderState *record);
extern void cypher_heap2_desc(StringInfo buf, XLogReaderState *record);
extern const char *cypher_heap2_identify(uint8 info);
extern void cypher_heap_xlog_logical_rewrite(XLogReaderState *r);

extern XLogRecPtr cypher_log_heap_freeze(Relation reln, Buffer buffer,
								  TransactionId cutoff_xid, xl_heap_freeze_tuple *tuples,
								  int ntuples);
extern bool cypher_heap_prepare_freeze_tuple(HeapTupleHeader tuple,
									  ...
									  bool *totally_frozen);
extern void cypher_heap_execute_freeze_tuple(HeapTupleHeader tuple,
									  xl_heap_freeze_tuple *xlrec_tp);
extern XLogRecPtr cypher_log_heap_visible(RelFileNode rnode, Buffer heap_buffer,
