 ...
 */
void
cypher_heap_toast_delete(Relation rel, HeapTuple oldtup, bool is_speculative)
{
	TupleDesc	tupleDesc;
 ...
 *	options: options to be passed to cypher_heap_insert() for toast rows
 * Result:
 ...
 */
HeapTuple
cypher_heap_toast_insert_or_update(Relation rel, HeapTuple newtup, HeapTuple oldtup,
							int options)
{
 ...
 */
HeapTuple
cypher_toast_flatten_tuple(HeapTuple tup, TupleDesc tupleDesc)
{
	HeapTuple	new_tuple;
 ...
 */
Datum
cypher_toast_flatten_tuple_to_datum(HeapTupleHeader tup,
							 uint32 tup_len,
							 TupleDesc tupleDesc)
{
	HeapTupleHeader new_data;
 ...
 */
HeapTuple
cypher_toast_build_flattened_tuple(TupleDesc tupleDesc,
							Datum *values,
							bool *isnull)
{
	HeapTuple	new_tuple;
 ...
 */
void
cypher_heap_fetch_toast_slice(Relation toastrel, Oid valueid, int32 attrsize,
