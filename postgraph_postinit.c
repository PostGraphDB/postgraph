 ...
 * This happens even before InitPostGraph.
 *
 * This is separate from InitPostGraph because it is also called by auxiliary
 * processes, such as the background writer process, which may not call
 * InitPostGraph at all.
 */
void
BaseInit(void)
{
 ...
 *
 * Note:
 *		Be very careful with the order of calls in the InitPostGraph function.
 * --------------------------------
 */
void
