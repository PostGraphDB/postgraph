...
/*
 * PostGraphInitProcess -- initialize a per-process data structure for this backend
 */
void
...
/*
 * PostGraphInitProcessPhase2 -- make MyProc visible in the shared ProcArray.
 *
 * This is separate from PostGraphInitProcess because we can't acquire LWLocks until
