...
CREATE FUNCTION vertex_out(vertex) RETURNS cstring LANGUAGE c STABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
CREATE FUNCTION build_vertex(graphid, oid, gtype) RETURNS vertex LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
...
CREATE FUNCTION build_edge(graphid, graphid, graphid, oid, gtype) RETURNS edge LANGUAGE c STABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
...
-- timestamp -> gtype
CREATE FUNCTION timestamp_to_gtype(timestamp) RETURNS gtype LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
CREATE CAST (timestamp AS gtype) WITH FUNCTION timestamp_to_gtype(timestamp);
-- timestamptz -> gtype
CREATE FUNCTION timestamptz_to_gtype(timestamptz) RETURNS gtype LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
CREATE CAST (timestamptz AS gtype) WITH FUNCTION timestamptz_to_gtype(timestamptz);
-- date -> gtype
CREATE FUNCTION date_to_gtype(date) RETURNS gtype LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME';
CREATE CAST (date AS gtype) WITH FUNCTION date_to_gtype(date);
-- time -> gtype
...
CREATE FUNCTION totimestamptz (gtype) RETURNS gtype LANGUAGE c IMMUTABLE PARALLEL SAFE RETURNS NULL ON NULL INPUT AS 'MODULE_PATHNAME';
CREATE FUNCTION totime(gtype) RETURNS gtype LANGUAGE c IMMUTABLE PARALLEL SAFE RETURNS NULL ON NULL INPUT AS 'MODULE_PATHNAME';
CREATE FUNCTION totimetz(gtype) RETURNS gtype LANGUAGE c IMMUTABLE PARALLEL SAFE RETURNS NULL ON NULL INPUT AS 'MODULE_PATHNAME';
CREATE FUNCTION tointerval(gtype) RETURNS gtype LANGUAGE c IMMUTABLE PARALLEL SAFE RETURNS NULL ON NULL INPUT AS 'MODULE_PATHNAME';
CREATE FUNCTION todate(gtype) RETURNS gtype LANGUAGE c IMMUTABLE PARALLEL SAFE RETURNS NULL ON NULL INPUT AS 'MODULE_PATHNAME';
...
CREATE FUNCTION age(gtype) RETURNS gtype LANGUAGE c STABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME', 'gtype_age_today';
...
CREATE FUNCTION date_bin(gtype, gtype, gtype) RETURNS gtype LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME', 'gtype_date_bin';
...
CREATE FUNCTION isfinite(gtype) RETURNS gtype LANGUAGE c IMMUTABLE RETURNS NULL ON NULL INPUT PARALLEL SAFE AS 'MODULE_PATHNAME', 'gtype_isfinite';
