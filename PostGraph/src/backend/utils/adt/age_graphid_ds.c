...
GraphIdNode *next_GraphIdNode(GraphIdNode *node) { return node->next; }

/* return the graphid */
graphid get_graphid(GraphIdNode *node) { return node->id; }

/* get the size of the passed queue */
int64 get_queue_size(ListGraphId *queue) { return queue->size; }
...
GraphIdNode *peek_queue_tail(ListGraphId *queue) { return queue->tail; }

/* return a reference to the head entry of a list */
GraphIdNode *get_list_head(ListGraphId *list) { return list->head; }

/* get the size of the passed list */
int64 get_list_size(ListGraphId *list) { return list->size; }
