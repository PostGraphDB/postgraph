...
Datum gtype_toupper(PG_FUNCTION_ARGS) {
  Datum d =
      DirectFunctionCall1Coll(upper, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_tolower(PG_FUNCTION_ARGS) {
  Datum d =
      DirectFunctionCall1Coll(lower, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_right(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall2(text_right, GT_ARG_TO_TEXT_DATUM(0),
                                GT_ARG_TO_INT8_DATUM(1));
...
Datum gtype_left(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall2(text_left, GT_ARG_TO_TEXT_DATUM(0),
                                GT_ARG_TO_INT8_DATUM(1));
...
Datum gtype_initcap(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(initcap, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_substring_w_len(PG_FUNCTION_ARGS) {
  Datum d =
      DirectFunctionCall3(text_substr, GT_ARG_TO_TEXT_DATUM(0),
                          GT_ARG_TO_INT4_DATUM(1), GT_ARG_TO_INT4_DATUM(2));

  gtype_value gtv = {
      .type = AGTV_STRING,
      .val.string = {VARSIZE(d), text_to_cstring(DatumGetTextP(d))}};
...
Datum gtype_substring(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall2(text_substr_no_len, GT_ARG_TO_TEXT_DATUM(0),
                                GT_ARG_TO_INT4_DATUM(1));
...
Datum gtype_split(PG_FUNCTION_ARGS) {
  Datum text_array =
      DirectFunctionCall2Coll(regexp_split_to_array, DEFAULT_COLLATION_OID,
                              GT_ARG_TO_TEXT_DATUM(0), GT_ARG_TO_TEXT_DATUM(1));
...
Datum gtype_replace(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall3Coll(
      replace_text, DEFAULT_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1), GT_ARG_TO_TEXT_DATUM(2));
...
Datum gtype_like(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      textlike, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
...
Datum gtype_not_like(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      textnlike, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_ilike(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      texticlike, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_not_ilike(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      texticnlike, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_eq_tilde(PG_FUNCTION_ARGS) {
  ...
  /*
      if (GT_IS_GEOMETRY(lhs) || GT_IS_GEOMETRY(rhs))
          PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2(gserialized_contains_2d,
     GT_TO_GEOMETRY_DATUM(lhs), GT_TO_GEOMETRY_DATUM(rhs))));
  */
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      textregexeq, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_match_case_insensitive(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      texticregexeq, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_regex_not_cs(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      textregexne, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_regex_not_ci(PG_FUNCTION_ARGS) {
  PG_RETURN_BOOL(DatumGetBool(DirectFunctionCall2Coll(
      texticregexne, C_COLLATION_OID, GT_ARG_TO_TEXT_DATUM(0),
      GT_ARG_TO_TEXT_DATUM(1))));
}
...
Datum gtype_sha224(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(sha224_bytea, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_sha256(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(sha256_bytea, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_sha384(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(sha384_bytea, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_sha512(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(sha512_bytea, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
...
Datum gtype_md5(PG_FUNCTION_ARGS) {
  Datum d = DirectFunctionCall1Coll(md5_text, C_COLLATION_OID,
                                    GT_ARG_TO_TEXT_DATUM(0));
