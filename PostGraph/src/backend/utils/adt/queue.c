...
QueueNode *next_queue_node(QueueNode *queuenode) { return queuenode->next; }

/* return the graphid */
graphid get_graphid(QueueNode *queuenode) { return queuenode->id; }

/* get the size of the passed queue */
int64 queue_size(Queue *queue) { return queue->size; }
...
QueueNode *peek_queue_tail(Queue *queue) { return queue->tail; }

/* return a reference to the head entry of a list */
QueueNode *get_list_head(Queue *list) { return list->head; }

/* get the size of the passed list */
int64 get_list_size(Queue *list) { return list->size; }
