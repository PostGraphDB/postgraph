...
IndexBulkDeleteResult *ivfflatbulkdelete(IndexVacuumInfo *info,
  ...
  while (BlockNumberIsValid(blkno)) {
    ...
    for (coffno = FirstOffsetNumber; coffno <= cmaxoffno;
      ...
      IvfflatList list =
          (IvfflatList)PageGetItem(cpage, PageGetItemId(cpage, coffno));
    ...
    for (coffno = FirstOffsetNumber; coffno <= cmaxoffno;
      ...
      while (BlockNumberIsValid(searchPage)) {
        ...
        for (offno = FirstOffsetNumber; offno <= maxoffno;
          ...
          IndexTuple itup =
              (IndexTuple)PageGetItem(page, PageGetItemId(page, offno));
      ...
      if (BlockNumberIsValid(insertPage)) {
        ...
        IvfflatUpdateList(index, listInfo, insertPage, InvalidBlockNumber,
