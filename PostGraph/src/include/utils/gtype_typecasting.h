...
#define GT_TO_INT8(arg) DatumGetInt64(GT_TO_INT8_DATUM(arg))
#define GT_TO_FLOAT8(arg) DatumGetFloat8(GT_TO_FLOAT8_DATUM(arg))
#define GT_TO_NUMERIC(arg) DatumGetFloat8(GT_TO_NUMERIC_DATUM(arg))
#define GT_TO_TEXT(arg) DatumGetTextP(GT_TO_TEXT_DATUM(arg))
#define GT_TO_STRING(arg) DatumGetCString(GT_TO_STRING_DATUM(arg))
...
#define GT_ARG_TO_NUMERIC_DATUM(arg)                                           \
  convert_to_scalar(gtype_to_numeric_internal, AG_GET_ARG_GTYPE_P(arg),        \
                    "numeric")
...
#define GT_ARG_TO_TIMESTAMP_DATUM(arg)                                         \
  convert_to_scalar(gtype_to_timestamp_internal, AG_GET_ARG_GTYPE_P(arg),      \
                    "timestamp")
#define GT_ARG_TO_TIMESTAMPTZ_DATUM(arg)                                       \
  convert_to_scalar(gtype_to_timestamptz_internal, AG_GET_ARG_GTYPE_P(arg),    \
                    "timestamptz")
...
#define GT_ARG_TO_TSVECTOR_DATUM(arg)                                          \
  convert_to_scalar(gtype_to_tsvector_internal, AG_GET_ARG_GTYPE_P(arg),       \
                    "tsvector")
#define GT_ARG_TO_TSQUERY_DATUM(arg)                                           \
  convert_to_scalar(gtype_to_tsquery_internal, AG_GET_ARG_GTYPE_P(arg),        \
                    "tsquery")
#define GT_ARG_TO_GEOMETRY_DATUM(arg)                                          \
  convert_to_scalar(gtype_to_geometry_internal, AG_GET_ARG_GTYPE_P(arg),       \
                    "geometry")
