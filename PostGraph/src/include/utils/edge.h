...
#define EXTRACT_EDGE_ID(e) (*((int64 *)(&((edge *)e)->children[0])))

#define EXTRACT_EDGE_STARTID(e) (*((int64 *)(&((edge *)e)->children[2])))

#define EXTRACT_EDGE_ENDID(e) (*((int64 *)(&((edge *)e)->children[4])))

#define EXTRACT_EDGE_GRAPH_OID(v) (*((Oid *)(&((edge *)v)->children[6])))
...
#define EDGEOID                                                                \
  (GetSysCacheOid2(TYPENAMENSP, Anum_pg_type_oid, CStringGetDatum("edge"),     \
                   ObjectIdGetDatum(postgraph_namespace_id())))

#define EDGEARRAYOID                                                           \
  (GetSysCacheOid2(TYPENAMENSP, Anum_pg_type_oid, CStringGetDatum("_edge"),    \
                   ObjectIdGetDatum(postgraph_namespace_id())))
