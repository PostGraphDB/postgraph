...
#define EXTRACT_VERTEX_ID(v) (*((int64 *)(&((vertex *)v)->children[0])))

#define EXTRACT_VERTEX_GRAPH_OID(v) (*((Oid *)(&((vertex *)v)->children[2])))
...
#define VERTEXOID                                                              \
  (GetSysCacheOid2(TYPENAMENSP, Anum_pg_type_oid, CStringGetDatum("vertex"),   \
                   ObjectIdGetDatum(postgraph_namespace_id())))

#define VERTEXARRAYOID                                                         \
  (GetSysCacheOid2(TYPENAMENSP, Anum_pg_type_oid, CStringGetDatum("_vertex"),  \
                   ObjectIdGetDatum(postgraph_namespace_id())))
